...
const News=(props)=> {
  ...
  const updateNews=async()=>{
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=d6f31448d0924d79863fcf8c80a29b05&page=${page}&pagesize=${props.pageSize}`;
    setLoading(true)
  ...
  const fetchMoreData = async() => {
    const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=d6f31448d0924d79863fcf8c80a29b05&page=${page+1}&pagesize=${props.pageSize}`;
    setPage(page+1)
    let data = await fetch(url);
    let parsedData = await data.json();
